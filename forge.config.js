module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      // 更多关于 config 的配置项，请参考：https://js.electronforge.io/interfaces/_electron_forge_maker_dmg.MakerDMGConfig.html
      config: {
        // 指定 DMG 图标：https://www.electronforge.io/guides/create-and-add-icons
